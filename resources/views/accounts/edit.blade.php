...
<head>
    ...
    <title>Edit User - KitesurfingVS</title>
    ...
    <div class="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row gap-6">
        ...
        <div class="flex-1">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="p-6">
                    <form action="{{ route('accounts.update', $user) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="flex items-center p-4 bg-offwhite rounded-lg">
                                <div class="h-16 w-16 rounded-full bg-accent/10 flex items-center justify-center mr-4">
                                    <span class="text-xl font-medium text-accent">
                                        {{ strtoupper(substr($user->firstname, 0, 1) . substr($user->lastname, 0, 1)) }}
                                    </span>
                                </div>
                                <div>
                                    <h3 class="text-xl font-bold text-gray-900">{{ $user->firstname }}
                                        {{ $user->infix }} {{ $user->lastname }}</h3>
                                    <p class="text-sm text-gray-600">{{ $user->email }}</p>
                                    <p class="text-xs text-gray-500">User ID: {{ $user->id }} • Created:
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="mt-1 text-sm text-blue-700">
                                                <p>To reset this user's password, please use the password reset
                                                    function.</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <!-- Role Information -->
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 border-b pb-2 mb-4">Role Information</h3>
                                <div>
                                    <label for="role_id" class="block text-sm font-medium text-gray-700 mb-1">Role
